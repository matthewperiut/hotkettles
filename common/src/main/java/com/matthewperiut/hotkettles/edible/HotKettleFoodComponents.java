...
public class HotKettleFoodComponents {
    ...
    public static final FoodComponent HOT_DRINK           = (new FoodComponent.Builder()).nutrition(0).saturationModifier(1.F).alwaysEdible().build();
    ...
    /* Properties:    */                                  .nutrition(0).saturationModifier(1.F).alwaysEdible().build();
    ...
    /* Properties:    */                                  .nutrition(1).saturationModifier(1.F).alwaysEdible().build();
    ...
    /* Properties:    */                                  .nutrition(2).saturationModifier(1.F).alwaysEdible().build();

    public static final FoodComponent CUP_OF_MILK         = (new FoodComponent.Builder()).nutrition(0).saturationModifier(1.F).alwaysEdible().build();
    ...
    /* Properties:    */                                  .nutrition(1).saturationModifier(2.F).alwaysEdible().build();
    ...
    /* Status Effect: */                                  //.arch$effect( ()-> new StatusEffectInstance(StatusEffects.HASTE, 90 * 20, 1), 1.0F )
    /* Properties:    */                                  .nutrition(2).saturationModifier(2.F).alwaysEdible().build();
    ...
    /* Properties:    */                                  .nutrition(2).saturationModifier(3.F).alwaysEdible().build();
