...
public class HotKettleBlocks {
    ...
    public static final RegistrySupplier<Block> KETTLE = BLOCKS.register(KETTLE_ID, () -> new KettleBlock(AbstractBlock.Settings.create().strength(0.5F).resistance(0.5F).registryKey(KETTLE_KEY)));
    ...
    public static final RegistrySupplier<Block> EMPTY_MUG = BLOCKS.register(EMPTY_MUG_ID, () -> new MugBlock(AbstractBlock.Settings.create().strength(0.5F).resistance(0.5F).registryKey(EMPTY_MUG_KEY)));
    ...
    public static final RegistrySupplier<Block> APPLE_CIDER = BLOCKS.register(APPLE_CIDER_ID, () -> new MugBlock(AbstractBlock.Settings.create().strength(0.5F).resistance(0.5F).registryKey(APPLE_CIDER_KEY)));
    ...
    public static final RegistrySupplier<Block> BITTER_WATER = BLOCKS.register(BITTER_WATER_ID, () -> new MugBlock(AbstractBlock.Settings.create().strength(0.5F).resistance(0.5F).registryKey(BITTER_WATER_KEY)));
    ...
    public static final RegistrySupplier<Block> CUP_OF_MILK = BLOCKS.register(CUP_OF_MILK_ID, () -> new MugBlock(AbstractBlock.Settings.create().strength(0.5F).resistance(0.5F).registryKey(CUP_OF_MILK_KEY)));
    ...
    public static final RegistrySupplier<Block> POISON = BLOCKS.register(POISON_ID, () -> new MugBlock(AbstractBlock.Settings.create().strength(0.5F).resistance(0.5F).registryKey(POISON_KEY)));
    ...
    public static final RegistrySupplier<Block> CUP_OF_WATER = BLOCKS.register(CUP_OF_WATER_ID, () -> new MugBlock(AbstractBlock.Settings.create().strength(0.5F).resistance(0.5F).registryKey(CUP_OF_WATER_KEY)));
    ...
    public static final RegistrySupplier<Block> CUP_OF_LAVA = BLOCKS.register(CUP_OF_LAVA_ID, () -> new MugBlock(AbstractBlock.Settings.create().strength(0.5F).resistance(0.5F).luminance((state) -> 12).registryKey(CUP_OF_LAVA_KEY)));
    ...
    public static final RegistrySupplier<Block> HOT_CHOCOLATE = BLOCKS.register(HOT_CHOCOLATE_ID, () -> new MugBlock(AbstractBlock.Settings.create().strength(0.5F).resistance(0.5F).registryKey(HOT_CHOCOLATE_KEY)));
    ...
    public static final RegistrySupplier<Block> LATTE = BLOCKS.register(LATTE_ID, () -> new MugBlock(AbstractBlock.Settings.create().strength(0.5F).resistance(0.5F).registryKey(LATTE_KEY)));
    ...
    public static final RegistrySupplier<Block> MOCHA = BLOCKS.register(MOCHA_ID, () -> new MugBlock(AbstractBlock.Settings.create().strength(0.5F).resistance(0.5F).registryKey(MOCHA_KEY)));
    ...
    public static final RegistrySupplier<Block> PUMPKIN_SPICE_LATTE = BLOCKS.register(PUMPKIN_SPICE_LATTE_ID, () -> new MugBlock(AbstractBlock.Settings.create().strength(0.5F).resistance(0.5F).registryKey(PUMPKIN_SPICE_LATTE_KEY)));
    ...
    public static final RegistrySupplier<Block> DANDELION_TEA = BLOCKS.register(DANDELION_TEA_ID, () -> new MugBlock(AbstractBlock.Settings.create().strength(0.5F).resistance(0.5F).registryKey(DANDELION_TEA_KEY)));
    ...
    public static final RegistrySupplier<Block> ROSE_TEA = BLOCKS.register(ROSE_TEA_ID, () -> new MugBlock(AbstractBlock.Settings.create().strength(0.5F).resistance(0.5F).registryKey(ROSE_TEA_KEY)));
    ...
    public static final RegistrySupplier<Block> FAIRY_TEA = BLOCKS.register(FAIRY_TEA_ID, () -> new MugBlock(AbstractBlock.Settings.create().strength(0.5F).resistance(0.5F).registryKey(FAIRY_TEA_KEY)));
