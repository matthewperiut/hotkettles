...
public class HotKettleItems {
    ...
    public static RegistrySupplier<Item> hot_cider         = ITEMS.register(new Identifier(MOD_ID, "hot_cider"), () -> new MugItem(HotKettleBlocks.apple_cider.get(), new Item.Settings().food(HOT_CIDER), true));
    ...
    public static RegistrySupplier<Item> hot_cocoa        = ITEMS.register(new Identifier(MOD_ID, "hot_cocoa"), () -> new MugItem(HotKettleBlocks.bitter_water.get(), new Item.Settings().food(HOT_COCOA), true));
    ...
    public static RegistrySupplier<Item> steamed_milk        = ITEMS.register(new Identifier(MOD_ID, "steamed_milk"), () -> new MugItem(HotKettleBlocks.cup_of_milk.get(), new Item.Settings().food(STEAMED_MILK), true));
    ...
    public static RegistrySupplier<Item> hot_water        = ITEMS.register(new Identifier(MOD_ID, "hot_water"), () -> new MugItem(HotKettleBlocks.cup_of_water.get(), new Item.Settings().food(HOT_WATER), true));
    ...
    public static void init() {
        ...
        // todo: fix
//        CreativeTabRegistry.modify(KETTLE_TAB, (featureSet, creativeTabOutput, builtin) -> {
...
//            CreativeTabRegistry.append(KETTLE_TAB, hot_water.get());
//            CreativeTabRegistry.append(KETTLE_TAB, apple_cider.get());
//            CreativeTabRegistry.append(KETTLE_TAB, hot_cider.get());
//            CreativeTabRegistry.append(KETTLE_TAB, bitter_water.get());
//            CreativeTabRegistry.append(KETTLE_TAB, hot_cocoa.get());
//            CreativeTabRegistry.append(KETTLE_TAB, cup_of_milk.get());
//            CreativeTabRegistry.append(KETTLE_TAB, steamed_milk.get());
