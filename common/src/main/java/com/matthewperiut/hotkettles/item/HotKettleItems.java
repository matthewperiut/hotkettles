...
public class HotKettleItems {
    ...
    public static final RegistrySupplier<Item> CLAY_MUG = ITEMS.register(CLAY_MUG_ID, () -> new Item(new Item.Settings().arch$tab(KETTLE_TAB)));
    ...
    public static final RegistrySupplier<Item> EMPTY_MUG = ITEMS.register(EMPTY_MUG_ID, () -> new EmptyMugItem(HotKettleBlocks.EMPTY_MUG.get(), new Item.Settings().arch$tab(KETTLE_TAB)));
    ...
    public static final RegistrySupplier<Item> APPLE_CIDER = ITEMS.register(APPLE_CIDER_ID, () -> new MugItem(HotKettleBlocks.APPLE_CIDER.get(), new Item.Settings().food(HotKettleFoodComponents.APPLE_CIDER).arch$tab(KETTLE_TAB)));
    ...
    public static final RegistrySupplier<Item> HOT_CIDER = ITEMS.register(HOT_CIDER_ID, () -> new MugItem(HotKettleBlocks.APPLE_CIDER.get(), new Item.Settings().food(HotKettleFoodComponents.HOT_CIDER).arch$tab(KETTLE_TAB), true));
    ...
    public static final RegistrySupplier<Item> BITTER_WATER = ITEMS.register(BITTER_WATER_ID, () -> new MugItem(HotKettleBlocks.BITTER_WATER.get(), new Item.Settings().food(HotKettleFoodComponents.BITTER_WATER).arch$tab(KETTLE_TAB)));
    ...
    public static final RegistrySupplier<Item> HOT_COCOA = ITEMS.register(HOT_COCOA_ID, () -> new MugItem(HotKettleBlocks.BITTER_WATER.get(), new Item.Settings().food(HotKettleFoodComponents.HOT_COCOA).arch$tab(KETTLE_TAB), true));
    ...
    public static final RegistrySupplier<Item> CUP_OF_MILK = ITEMS.register(CUP_OF_MILK_ID, () -> new MugItem(HotKettleBlocks.CUP_OF_MILK.get(), new Item.Settings().food(HotKettleFoodComponents.CUP_OF_MILK).arch$tab(KETTLE_TAB)));
    ...
    public static final RegistrySupplier<Item> STEAMED_MILK = ITEMS.register(STEAMED_MILK_ID, () -> new MugItem(HotKettleBlocks.CUP_OF_MILK.get(), new Item.Settings().food(HotKettleFoodComponents.STEAMED_MILK).arch$tab(KETTLE_TAB), true));
    ...
    public static final RegistrySupplier<Item> POISON = ITEMS.register(POISON_ID, () -> new MugItem(HotKettleBlocks.POISON.get(), new Item.Settings().food(HotKettleFoodComponents.POISON).arch$tab(KETTLE_TAB)));
    ...
    public static final RegistrySupplier<Item> CUP_OF_WATER = ITEMS.register(CUP_OF_WATER_ID, () -> new MugItem(HotKettleBlocks.CUP_OF_WATER.get(), new Item.Settings().food(HotKettleFoodComponents.CUP_OF_WATER).arch$tab(KETTLE_TAB)));
    ...
    public static final RegistrySupplier<Item> HOT_WATER = ITEMS.register(HOT_WATER_ID, () -> new MugItem(HotKettleBlocks.CUP_OF_WATER.get(), new Item.Settings().food(HotKettleFoodComponents.HOT_WATER).arch$tab(KETTLE_TAB), true));
    ...
    public static final RegistrySupplier<Item> CUP_OF_LAVA = ITEMS.register(CUP_OF_LAVA_ID, () -> new MugItem(HotKettleBlocks.CUP_OF_LAVA.get(), new Item.Settings().food(HotKettleFoodComponents.CUP_OF_LAVA).arch$tab(KETTLE_TAB)));
    ...
    public static final RegistrySupplier<Item> HOT_CHOCOLATE = ITEMS.register(HOT_CHOCOLATE_ID, () -> new MugItem(HotKettleBlocks.HOT_CHOCOLATE.get(), new Item.Settings().food(HotKettleFoodComponents.HOT_CHOCOLATE).arch$tab(KETTLE_TAB)));
    ...
    public static final RegistrySupplier<Item> LATTE = ITEMS.register(LATTE_ID, () -> new MugItem(HotKettleBlocks.LATTE.get(), new Item.Settings().food(HotKettleFoodComponents.LATTE).arch$tab(KETTLE_TAB)));
    ...
    public static final RegistrySupplier<Item> MOCHA = ITEMS.register(MOCHA_ID, () -> new MugItem(HotKettleBlocks.MOCHA.get(), new Item.Settings().food(HotKettleFoodComponents.MOCHA).arch$tab(KETTLE_TAB)));
    ...
    public static final RegistrySupplier<Item> PUMPKIN_SPICE_LATTE = ITEMS.register(PUMPKIN_SPICE_LATTE_ID, () -> new MugItem(HotKettleBlocks.PUMPKIN_SPICE_LATTE.get(), new Item.Settings().food(HotKettleFoodComponents.PUMPKIN_SPICE_LATTE).arch$tab(KETTLE_TAB)));
    ...
    public static final RegistrySupplier<Item> DANDELION_TEA = ITEMS.register(DANDELION_TEA_ID, () -> new MugItem(HotKettleBlocks.DANDELION_TEA.get(), new Item.Settings().food(HotKettleFoodComponents.DANDELION_TEA).arch$tab(KETTLE_TAB)));
    ...
    public static final RegistrySupplier<Item> ROSE_TEA = ITEMS.register(ROSE_TEA_ID, () -> new MugItem(HotKettleBlocks.ROSE_TEA.get(), new Item.Settings().food(HotKettleFoodComponents.ROSE_TEA).arch$tab(KETTLE_TAB)));
    ...
    public static final RegistrySupplier<Item> FAIRY_TEA = ITEMS.register(FAIRY_TEA_ID, () -> new MugItem(HotKettleBlocks.FAIRY_TEA.get(), new Item.Settings().food(HotKettleFoodComponents.FAIRY_TEA).arch$tab(KETTLE_TAB)));
    ...
    public static final RegistrySupplier<Item> KETTLE = ITEMS.register(KETTLE_ID, () -> new KettleItem(HotKettleBlocks.KETTLE.get(), new KettleItem.Settings().arch$tab(KETTLE_TAB), 0));
    ...
    public static final RegistrySupplier<Item> POISON_KETTLE = ITEMS.register(POISON_KETTLE_ID, () -> new KettleItem(HotKettleBlocks.KETTLE.get(), new KettleItem.Settings().arch$tab(KETTLE_TAB), 1));
    ...
    public static final RegistrySupplier<Item> WATER_KETTLE = ITEMS.register(WATER_KETTLE_ID, () -> new KettleItem(HotKettleBlocks.KETTLE.get(), new KettleItem.Settings().arch$tab(KETTLE_TAB), 2));
    ...
    public static final RegistrySupplier<Item> MILK_KETTLE = ITEMS.register(MILK_KETTLE_ID, () -> new KettleItem(HotKettleBlocks.KETTLE.get(), new KettleItem.Settings().arch$tab(KETTLE_TAB), 3));
    ...
    public static final RegistrySupplier<Item> BITTER_KETTLE = ITEMS.register(BITTER_KETTLE_ID, () -> new KettleItem(HotKettleBlocks.KETTLE.get(), new KettleItem.Settings().arch$tab(KETTLE_TAB), 4));
    ...
    public static final RegistrySupplier<Item> APPLE_KETTLE = ITEMS.register(APPLE_KETTLE_ID, () -> new KettleItem(HotKettleBlocks.KETTLE.get(), new KettleItem.Settings().arch$tab(KETTLE_TAB), 5));
    ...
    public static final RegistrySupplier<Item> LAVA_KETTLE = ITEMS.register(LAVA_KETTLE_ID, () -> new KettleItem(HotKettleBlocks.KETTLE.get(), new KettleItem.Settings().arch$tab(KETTLE_TAB), 6));
