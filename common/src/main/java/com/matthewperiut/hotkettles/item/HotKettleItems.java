...
public class HotKettleItems {
    ...
    public static final RegistrySupplier<Item> APPLE_CIDER = ITEMS.register(APPLE_CIDER_ID, () -> new MugItem(HotKettleBlocks.APPLE_CIDER.get(), new Item.Settings().food(HotKettleFoodComponents.ALWAYS_CONSUMABLE, HotKettlesConsumableComponents.APPLE_CIDER).arch$tab(KETTLE_TAB).registryKey(APPLE_CIDER_KEY).useBlockPrefixedTranslationKey()));
    ...
    public static final RegistrySupplier<Item> BITTER_WATER = ITEMS.register(BITTER_WATER_ID, () -> new MugItem(HotKettleBlocks.BITTER_WATER.get(), new Item.Settings().food(HotKettleFoodComponents.ALWAYS_CONSUMABLE, HotKettlesConsumableComponents.BITTER_WATER).arch$tab(KETTLE_TAB).registryKey(BITTER_WATER_KEY).useBlockPrefixedTranslationKey()));
    ...
    public static final RegistrySupplier<Item> CUP_OF_MILK = ITEMS.register(CUP_OF_MILK_ID, () -> new MugItem(HotKettleBlocks.CUP_OF_MILK.get(), new Item.Settings().food(HotKettleFoodComponents.ALWAYS_CONSUMABLE, HotKettlesConsumableComponents.CUP_OF_MILK).arch$tab(KETTLE_TAB).registryKey(CUP_OF_MILK_KEY).useBlockPrefixedTranslationKey()));
    ...
    public static final RegistrySupplier<Item> POISON = ITEMS.register(POISON_ID, () -> new MugItem(HotKettleBlocks.POISON.get(), new Item.Settings().food(HotKettleFoodComponents.ALWAYS_CONSUMABLE, HotKettlesConsumableComponents.POISON).arch$tab(KETTLE_TAB).registryKey(POISON_KEY).useBlockPrefixedTranslationKey()));
    ...
    public static final RegistrySupplier<Item> CUP_OF_WATER = ITEMS.register(CUP_OF_WATER_ID, () -> new MugItem(HotKettleBlocks.CUP_OF_WATER.get(), new Item.Settings().food(HotKettleFoodComponents.ALWAYS_CONSUMABLE, HotKettlesConsumableComponents.CUP_OF_WATER).arch$tab(KETTLE_TAB).registryKey(CUP_OF_WATER_KEY).useBlockPrefixedTranslationKey()));
    ...
    public static final RegistrySupplier<Item> CUP_OF_LAVA = ITEMS.register(CUP_OF_LAVA_ID, () -> new MugItem(HotKettleBlocks.CUP_OF_LAVA.get(), new Item.Settings().food(HotKettleFoodComponents.ALWAYS_CONSUMABLE, HotKettlesConsumableComponents.CUP_OF_LAVA).arch$tab(KETTLE_TAB).registryKey(CUP_OF_LAVA_KEY).useBlockPrefixedTranslationKey()));
    ...
    public static final RegistrySupplier<Item> HOT_CHOCOLATE = ITEMS.register(HOT_CHOCOLATE_ID, () -> new MugItem(HotKettleBlocks.HOT_CHOCOLATE.get(), new Item.Settings().food(HotKettleFoodComponents.ALWAYS_CONSUMABLE, HotKettlesConsumableComponents.HOT_CHOCOLATE).arch$tab(KETTLE_TAB).registryKey(HOT_CHOCOLATE_KEY).useBlockPrefixedTranslationKey()));
    ...
    public static final RegistrySupplier<Item> LATTE = ITEMS.register(LATTE_ID, () -> new MugItem(HotKettleBlocks.LATTE.get(), new Item.Settings().food(HotKettleFoodComponents.ALWAYS_CONSUMABLE, HotKettlesConsumableComponents.LATTE).arch$tab(KETTLE_TAB).registryKey(LATTE_KEY).useBlockPrefixedTranslationKey()));
    ...
    public static final RegistrySupplier<Item> MOCHA = ITEMS.register(MOCHA_ID, () -> new MugItem(HotKettleBlocks.MOCHA.get(), new Item.Settings().food(HotKettleFoodComponents.ALWAYS_CONSUMABLE, HotKettlesConsumableComponents.MOCHA).arch$tab(KETTLE_TAB).registryKey(MOCHA_KEY).useBlockPrefixedTranslationKey()));
    ...
    public static final RegistrySupplier<Item> PUMPKIN_SPICE_LATTE = ITEMS.register(PUMPKIN_SPICE_LATTE_ID, () -> new MugItem(HotKettleBlocks.PUMPKIN_SPICE_LATTE.get(), new Item.Settings().food(HotKettleFoodComponents.ALWAYS_CONSUMABLE, HotKettlesConsumableComponents.PUMPKIN_SPICE_LATTE).arch$tab(KETTLE_TAB).registryKey(PUMPKIN_SPICE_LATTE_KEY).useBlockPrefixedTranslationKey()));
    ...
    public static final RegistrySupplier<Item> DANDELION_TEA = ITEMS.register(DANDELION_TEA_ID, () -> new MugItem(HotKettleBlocks.DANDELION_TEA.get(), new Item.Settings().food(HotKettleFoodComponents.ALWAYS_CONSUMABLE, HotKettlesConsumableComponents.DANDELION_TEA).arch$tab(KETTLE_TAB).registryKey(DANDELION_TEA_KEY).useBlockPrefixedTranslationKey()));
    ...
    public static final RegistrySupplier<Item> ROSE_TEA = ITEMS.register(ROSE_TEA_ID, () -> new MugItem(HotKettleBlocks.ROSE_TEA.get(), new Item.Settings().food(HotKettleFoodComponents.ALWAYS_CONSUMABLE, HotKettlesConsumableComponents.ROSE_TEA).arch$tab(KETTLE_TAB).registryKey(ROSE_TEA_KEY).useBlockPrefixedTranslationKey()));
    ...
    public static final RegistrySupplier<Item> FAIRY_TEA = ITEMS.register(FAIRY_TEA_ID, () -> new MugItem(HotKettleBlocks.FAIRY_TEA.get(), new Item.Settings().food(HotKettleFoodComponents.ALWAYS_CONSUMABLE, HotKettlesConsumableComponents.FAIRY_TEA).arch$tab(KETTLE_TAB).registryKey(FAIRY_TEA_KEY).useBlockPrefixedTranslationKey()));
